...
<style>
body {
  background-image: url('images/r1.jfif');
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>pms| Patient Registration</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<div class="form-group">
								<input type="text" class="form-control" name="sub_city" placeholder="sub_city" required>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="wereda" placeholder="wereda" required>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="home number" placeholder="home number" required>
							</div>
							<div class="form-group">
								<label class="block">
									Gender
